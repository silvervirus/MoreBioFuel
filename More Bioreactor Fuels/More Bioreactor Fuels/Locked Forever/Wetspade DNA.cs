...
namespace More_Bioreactor_Fuels.LockForever
{
...

    {
        ...
        public static void Patch()
        {
            ...
            Info = Utilities.CreatePrefabInfo("bFWetspadeDNA", "Fatspade DNA ", "Contains the genetic code of a Wetspade fish.", Utilities.GetSprite("bFWetspadeDNA"), 1, 1);
            ...
            prefab.SetGameObject(new CloneTemplate(bFWetspadeDNA.Info, TechType.Spadefish)
            {
