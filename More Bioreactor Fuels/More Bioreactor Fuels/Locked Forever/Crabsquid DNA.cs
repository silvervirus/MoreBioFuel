...
namespace More_Bioreactor_Fuels.LockForever
{
...

    {
        ...
        public static void Patch()
        {
            ...
            Info = Utilities.CreatePrefabInfo("bFCrabsquidDNA", "Crabsquid DNA ", "Contains the genetic code of a Crabsquid.", Utilities.GetSprite("bFCrabsquidDNA"), 1, 1);
            ...
            prefab.SetGameObject(new CloneTemplate(bFCrabsquidDNA.Info, TechType.Spadefish)
            {
