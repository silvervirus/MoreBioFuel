...
namespace More_Bioreactor_Fuels.LockForever
{
...

    {
        ...
        public static void Patch()
        {
            ...
            Info = Utilities.CreatePrefabInfo("bFFatspadeDNA", "Fatspade DNA ", "Contains the genetic code of a Fatspade fish.", Utilities.GetSprite("bFFatspadeDNA"), 1, 1);
            ...
            prefab.SetGameObject(new CloneTemplate(bFFatspadeDNA.Info, TechType.Spadefish)
            {
