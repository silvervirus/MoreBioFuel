...
namespace More_Bioreactor_Fuels.LockForever
{
...

    {
        ...
        public static void Patch()
        {
            ...
            Info = Utilities.CreatePrefabInfo("bFSeaWater", "Sea Water ", "Water from the sea, compound of dissolved salts 1000ϟ. ", Utilities.GetSprite("bFSeaWater0"), 1, 1);
            ...
            prefab.SetGameObject(new CloneTemplate(bFSeaWater.Info, TechType.FilteredWater)
            {
