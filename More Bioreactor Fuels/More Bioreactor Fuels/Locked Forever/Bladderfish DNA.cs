...
{
    internal class bFBladderfishDNA

    {
        ...
        public static void Patch()
        {
            ...
            Info = Utilities.CreatePrefabInfo("bFBladderfishDNA", "Bladderfish DNA ", "Contains the genetic code of a Bladderfish.", Utilities.GetSprite("bFBladderfishDNA"), 1, 1);
            ...
            prefab.SetGameObject(new CloneTemplate(bFBladderfishDNA.Info, TechType.Spadefish)
            {
