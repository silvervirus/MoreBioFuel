...
{
    internal class AmmoniaSeawater

    {
        ...
        public static void Patch()
        {
            ...
            Info = Utilities.CreatePrefabInfo("bFAmmoniaFromSeaWater", "Ammonia ", "Ammonia is used as a refrigerant gas, for purification of water supplies, and in the manufacture of plastics, explosives, textiles, pesticides, dyes and other chemicals 11 000 ", Utilities.GetSprite("bFAmmoniaFromSeaWater"), 1, 1);
            ...
            prefab.SetGameObject(new CloneTemplate(AmmoniaSeawater.Info, TechType.FilteredWater)
            {
